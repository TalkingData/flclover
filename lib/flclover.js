...
const FeatherLogger = require('./middleware/logger');
const FeatherProxy = require('./middleware/proxy');
...
module.exports = (options = {}) => {
  ...
  app.use(KoaLogger());
  app.use(FeatherLogger(config.featherLogger || {
    baseDir: options.baseDir,
  }));
  app.use(FeatherProxy(config.featherProxy));
