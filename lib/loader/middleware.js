  ...
  loadMiddleware() {
    ...
    if (middlewares) {
      middlewares.forEach((middleware) => {
        ...
        // this.app.logger.info(`bind middleware ${middleware}`);
    ...
    // this.app.logger.info('bind middleware bodyParser');
    ...
    // }
    // this.app.logger.info('bind middleware flcloverLogger');
    this.app.use(FlcloverLogger(this.app.config.logger));
